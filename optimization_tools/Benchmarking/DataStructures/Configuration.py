...
from Benchmarking.DataStructures.Parameters import (
    Parameter,
    CategoricalParameter,
    DiscreteParameter,
    getCompressionParameter,
    getClusterSizeParameter,
    getClusterBunchParameter,
...
class Configuration:
    ...
    def createBaseConfig(self):
        ...
        self.page_size = DiscreteParameter(
            "Page Size",
            convertToByteList(page_sizes, base=2),
        ...
        self.cluster_size = DiscreteParameter(
            "Cluster Size",
            convertToByteList(cluster_sizes, base=10),
    ...
    def step(self):
        ...
        self.mutated_variable = self.mutatable_parameters[
            choice(range(len(self.mutatable_parameters)))
        ]
    ...
    def step_multi(self, prop):
        ...
        for i in idxs_to_change:
            ...
            self.mutated_mutatable_parameters.append(self.mutatable_parameters[i])
    ...
    def evaluate(
        ...
        return evaluate_parameters(
            ...
            self.cluster_bunch.value,
            path_to_output_folder=path_to_output_folder,
            evaluations=evaluations,
            remove_generated_file=remove_generated_file,
        )


def getConfiguration(
    compression_type: str = default_variable_values["compression_type"],
    cluster_size: int = default_variable_values["cluster_size"],
    page_size: int = default_variable_values["page_size"],
    cluster_bunch: int = default_variable_values["cluster_bunch"],
